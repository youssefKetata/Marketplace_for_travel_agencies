        ...
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                tpl: {
                    ...
                    clearButton: '<button type="button" class="dropify-clear" data-action="modal-form#openModal">{{ remove }}</button>',
                    editButton: '<button type="button" class="dropify-clear pull-left primary-buttom"  data-bs-toggle="modal"  data-bs-target="#editPhoto" >{{ edit }}</button>',
